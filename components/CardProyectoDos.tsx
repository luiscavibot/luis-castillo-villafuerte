...
const CardProyectoDos: FC<Props> = ({ title, description, tools, link }) => {
	return (
		<div className="flex flex-col justify-between col-span-full sm:col-span-1 rounded-lg p-6 text-sm bg-white/10 hover:scale-105 transition-transform hover:bg-white/20">
			<div>
